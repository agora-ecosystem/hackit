...
/**
 * HackitIterator extends {@link FunctionIterator} and provides a signature for
 * the conversion of the tuples into a {@link HackitTuple} during they process.
 *
...
public class HackitIterator<K, T> extends FunctionIterator<T, HackitTuple<K, T>>{
    ...
    /**
     * default construct
     * @param base {@link Iterator} that element will be wrap a {@link HackitTuple}
