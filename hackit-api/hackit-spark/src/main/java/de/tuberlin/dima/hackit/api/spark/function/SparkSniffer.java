...
public class SparkSniffer<K, T> extends HackitSniffer<K, T, byte[], SenderKafka<K, byte[]>, ReceiverKafka<K, HackitTuple<K, T>>> {

    public SparkSniffer(Properties conf) {
        super(
                new EmptyInjector<HackitTuple<K, T>>(),
                new EmptyActor<K, T>(),
